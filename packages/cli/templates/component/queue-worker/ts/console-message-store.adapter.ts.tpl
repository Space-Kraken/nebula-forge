 ...
 * port. Replace it with a real one — e.g. a DynamoDB adapter reading the
 * table name from the binding env var (process.env.TABLE_<NAME>_NAME) — and
 * rebind it in src/handler.ts.
 */
